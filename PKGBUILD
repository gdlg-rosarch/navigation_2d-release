...
pkgdesc="ROS - Contains a set of tutorials that run 2D-Navigation within Stage-Simulator."
url='http://wiki.ros.org/nav2d_tutorials'

pkgname='ros-kinetic-nav2d-tutorials'
pkgver='0.3.2_1'
pkgrel=1
arch=('any')
license=('GPLv3'
...
_dir=nav2d_tutorials
source=()
md5sums=()

prepare() {
    cp -R $startdir/nav2d_tutorials $srcdir/nav2d_tutorials
}
